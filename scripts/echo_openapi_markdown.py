...
""" Usage
    ...
    cd osparc-simcore
    ./scripts/echo_openapi_markdown.py >openapi.md
"""
...
def generate_markdown_table(openapi_files: list[tuple[Path, Path]]) -> str:
    ...
    for service_name, file_path in openapi_files:
        ...
        table += to_row((service_name, f"[{file_path}](./{file_path})", badges))
    return table
...
if __name__ == "__main__":
    ...
    print("# openapi")
    print()
    print("All openapi specs for the rest APIs on all services in this repository")
    print()
