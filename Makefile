...
echo "http://$(if $(IS_WSL2),$(get_my_ip),127.0.0.1.nip.io):9081                                                                 - oSparc platform"
echo "http://$(if $(IS_WSL2),$(get_my_ip),127.0.0.1.nip.io):18080/?pgsql=postgres&username=scu&db=simcoredb&ns=public  - Postgres DB"
echo "http://$(if $(IS_WSL2),$(get_my_ip),127.0.0.1.nip.io):9000                                                                 - Portainer"
endef
