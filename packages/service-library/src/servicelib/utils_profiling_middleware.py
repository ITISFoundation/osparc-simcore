...
from .mimetype_constants import MIMETYPE_APPLICATION_JSON, MIMETYPE_APPLICATION_NDJSON
...
def check_response_headers(
    ...
    assert original_content_type in {  # nosec
        MIMETYPE_APPLICATION_NDJSON,
        MIMETYPE_APPLICATION_JSON,
    }
    headers: dict = {}
    headers[b"content-type"] = MIMETYPE_APPLICATION_NDJSON.encode()
