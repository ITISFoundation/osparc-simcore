...
async def test_project_document_version_workflow(redis_client_sdk: RedisClientSDK, project_uuid: ProjectID):
    """Test the complete workflow of getting and incrementing project document versions."""

    # First increment should return 1
    new_version = await increment_and_return_project_document_version(redis_client_sdk, project_uuid)
