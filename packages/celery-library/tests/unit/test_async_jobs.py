...
from servicelib.celery.models import BaseExecutionMetadata, OwnerMetadata, TaskKey
...
@pytest.mark.parametrize(
    "execution_metadata",
    [
        BaseExecutionMetadata(name=sync_job.__name__),
        BaseExecutionMetadata(name=async_job.__name__),
    ],
)
@pytest.mark.parametrize(
    "payload",
