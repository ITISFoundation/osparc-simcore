...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("fk_user_to_projects_id_users", "user_to_projects", type_="foreignkey")
    op.drop_constraint("fk_user_to_projects_id_projects", "user_to_projects", type_="foreignkey")
    op.create_foreign_key(
