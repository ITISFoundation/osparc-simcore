...
def upgrade():
    ...
    op.create_unique_constraint("products_group_id_unique_constraint", "products", ["group_id"])
...
def downgrade():
    ...
    op.drop_constraint("products_group_id_unique_constraint", "products", type_="unique")
