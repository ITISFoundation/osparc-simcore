...
def downgrade():
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_payments_transactions_wallet_id"), table_name="payments_transactions")
    op.drop_index(op.f("ix_payments_transactions_user_id"), table_name="payments_transactions")
