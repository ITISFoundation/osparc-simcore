...
def upgrade():
    ...
    op.drop_constraint("services_vendor_secrets_pk", "services_vendor_secrets", type_="primary")
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("fk_services_name_products", "services_vendor_secrets", type_="foreignkey")
