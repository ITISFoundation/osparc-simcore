...
def upgrade():
    ...
    op.create_index(op.f("ix_funcapi_functions_uuid"), "funcapi_functions", ["uuid"], unique=False)
    op.create_table(
...
def downgrade():
    ...
    op.drop_index(op.f("ix_funcapi_function_jobs_uuid"), table_name="funcapi_function_jobs")
    op.drop_index(
        op.f("ix_funcapi_function_jobs_function_uuid"),
