...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("ACTIVE", "INACTIVE", name="walletstatus"), nullable=False),
        sa.Column(
            "created",
...
def downgrade():
    ...
    op.execute(assign_wallet_access_rights_to_owner_group_procedure)
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_projects_to_wallet_project_uuid"), table_name="projects_to_wallet")
