...
# TRIGGERS ------------------------
_TABLE_NAME: Final[str] = "users_pre_details"
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["accepted_by"], ["users.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
...
def downgrade():
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("users_pre_details")
    # ### end Alembic commands ###
