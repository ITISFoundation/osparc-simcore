...
def upgrade():
    ...
    op.add_column("comp_runs", sa.Column("use_on_demand_clusters", sa.Boolean(), nullable=True))
    # ### end Alembic commands ###
    op.execute(sa.DDL("UPDATE comp_runs SET use_on_demand_clusters = false WHERE use_on_demand_clusters IS NULL"))
    ...
    # new statetype
    op.execute(sa.DDL("ALTER TYPE statetype ADD VALUE IF NOT EXISTS 'WAITING_FOR_CLUSTER'"))
