...
def upgrade():
    ...
    op.add_column(
        ...
        sa.Column("licensed_item_purchase_id", postgresql.UUID(as_uuid=True), nullable=True),
    )
    # ### end Alembic commands ###
    op.execute(sa.DDL("ALTER TYPE credittransactionclassification ADD VALUE 'DEDUCT_LICENSE_PURCHASE'"))
