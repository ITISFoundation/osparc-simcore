...
def upgrade():
    ...
    # custom
    delete_orphaned_project_nodes_procedure.execute(bind=op.get_context().bind)
    projects_to_projects_nodes_deleted_trigger.execute(bind=op.get_context().bind)
...
def downgrade():
    # custom
    drop_projects_to_projects_nodes_deleted_trigger.execute(bind=op.get_context().bind)
    drop_delete_orphaned_project_nodes_procedure.execute(bind=op.get_context().bind)
    drop_modified_timestamp_trigger.execute(bind=op.get_context().bind)
    drop_update_modified_timestamp_procedure.execute(bind=op.get_context().bind)
