...
def upgrade():
    ...
    op.create_index(
        op.f("ix_zzz_resource_tracker_service_runs__osparc_io_archive_2026Q1_user_id"),
        "zzz_resource_tracker_service_runs__osparc_io_archive_2026Q1",
        ["user_id"],
        unique=False,
    )
    ...
    # Seems that when projects_to_wallet table was created, by mistake the FK was named:
    # fk_projects_comments_project_uuid
    # Which now causes trouble when dropping the projects_comments table which also has this foreign key name
    # in its definition
