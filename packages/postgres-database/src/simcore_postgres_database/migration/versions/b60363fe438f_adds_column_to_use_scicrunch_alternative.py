...
def upgrade():
    ...
    query = 'UPDATE "group_classifiers" SET uses_scicrunch_rrids=false;'
    op.execute(query)
    # makes non nullable
    query = 'ALTER TABLE "group_classifiers" ALTER "uses_scicrunch_rrids" SET NOT NULL;'
    op.execute(query)


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("group_classifiers", "uses_scicrunch_rrids")
    # ### end Alembic commands ###
