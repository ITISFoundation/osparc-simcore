"""New version control tables

Revision ID: 8009e15c567a
Revises: 61824f0aacb6
Create Date: 2021-09-03 06:10:16.332268+00:00
...
revision = "8009e15c567a"
down_revision = "61824f0aacb6"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # FIXME: SAWarning: Cannot correctly sort tables; there are unresolvable cycles between tables "projects_vc_branches, projects_vc_commits, projects_vc_repos", which is usually caused by mutually dependent foreign key constraints.
    # Foreign key constraints involving these tables will not be considered; this warning may raise an error in a future release
