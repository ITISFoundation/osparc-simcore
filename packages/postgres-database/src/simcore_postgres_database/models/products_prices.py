...
products_prices = sa.Table(
    ...
    sa.Column(
        ...
        "Must be in sync with Stripe product price (stripe_price_id column in this table).",
    ),
    sa.Column(
    ...
    sa.Column(
        ...
        sa.String,
        nullable=False,
        doc="Stripe product price must be in sync with usd_per_credit rate field in this table. "
        "Currently created manually in Stripe",
    ),
    sa.Column(
        "stripe_tax_rate_id",
        sa.String,
