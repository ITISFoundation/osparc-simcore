...
from simcore_director_sdk.exceptions import (
    ApiTypeError,
    ApiValueError
)
...
class UsersApi(object):
    ...
    def running_interactive_services_delete_with_http_info(self, service_uuid, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('service_uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['service_uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `service_uuid` when calling `running_interactive_services_delete`")  # noqa: E501
    ...
    def running_interactive_services_get_with_http_info(self, service_uuid, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('service_uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['service_uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `service_uuid` when calling `running_interactive_services_get`")  # noqa: E501
    ...
    def running_interactive_services_list_get(self, **kwargs):  # noqa: E501
        """Returns a list of interactive services  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.running_interactive_services_list_get(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.running_interactive_services_list_get_with_http_info(**kwargs)  # noqa: E501

    def running_interactive_services_list_get_with_http_info(self, **kwargs):  # noqa: E501
        """Returns a list of interactive services  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.running_interactive_services_list_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['user_id', 'project_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method running_interactive_services_list_get" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        return self.api_client.call_api(
            '/running_interactive_services', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def running_interactive_services_post_with_http_info(self, user_id, project_id, service_key, service_uuid, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('user_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `user_id` when calling `running_interactive_services_post`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if self.api_client.client_side_validation and ('project_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['project_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `project_id` when calling `running_interactive_services_post`")  # noqa: E501
        # verify the required parameter 'service_key' is set
        if self.api_client.client_side_validation and ('service_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['service_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `service_key` when calling `running_interactive_services_post`")  # noqa: E501
        # verify the required parameter 'service_uuid' is set
        if self.api_client.client_side_validation and ('service_uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['service_uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `service_uuid` when calling `running_interactive_services_post`")  # noqa: E501

        if self.api_client.client_side_validation and 'service_key' in local_var_params and not re.search(r'^(simcore)\/(services)\/(comp|dynamic)(\/[^\s\/]+)+$', local_var_params['service_key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `service_key` when calling `running_interactive_services_post`, must conform to the pattern `/^(simcore)\/(services)\/(comp|dynamic)(\/[^\s\/]+)+$/`")  # noqa: E501
        if self.api_client.client_side_validation and 'service_tag' in local_var_params and not re.search(r'^(0|[1-9]\d*)(\.(0|[1-9]\d*)){2}(-(0|[1-9]\d*|\d*[-a-zA-Z][-\da-zA-Z]*)(\.(0|[1-9]\d*|\d*[-a-zA-Z][-\da-zA-Z]*))*)?(\+[-\da-zA-Z]+(\.[-\da-zA-Z-]+)*)?$', local_var_params['service_tag']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `service_tag` when calling `running_interactive_services_post`, must conform to the pattern `/^(0|[1-9]\d*)(\.(0|[1-9]\d*)){2}(-(0|[1-9]\d*|\d*[-a-zA-Z][-\da-zA-Z]*)(\.(0|[1-9]\d*|\d*[-a-zA-Z][-\da-zA-Z]*))*)?(\+[-\da-zA-Z]+(\.[-\da-zA-Z-]+)*)?$/`")  # noqa: E501
        collection_formats = {}
        ...
        if 'project_id' in local_var_params and local_var_params['project_id'] is not None:  # noqa: E501
            query_params.append(('project_id', local_var_params['project_id']))  # noqa: E501
        if 'service_key' in local_var_params and local_var_params['service_key'] is not None:  # noqa: E501
            query_params.append(('service_key', local_var_params['service_key']))  # noqa: E501
        if 'service_tag' in local_var_params and local_var_params['service_tag'] is not None:  # noqa: E501
            query_params.append(('service_tag', local_var_params['service_tag']))  # noqa: E501
        if 'service_uuid' in local_var_params and local_var_params['service_uuid'] is not None:  # noqa: E501
            query_params.append(('service_uuid', local_var_params['service_uuid']))  # noqa: E501
        if 'service_basepath' in local_var_params and local_var_params['service_basepath'] is not None:  # noqa: E501
    ...
    def services_by_key_version_get_with_http_info(self, service_key, service_version, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('service_key' not in local_var_params or  # noqa: E501
                                                        local_var_params['service_key'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `service_key` when calling `services_by_key_version_get`")  # noqa: E501
        # verify the required parameter 'service_version' is set
        if self.api_client.client_side_validation and ('service_version' not in local_var_params or  # noqa: E501
                                                        local_var_params['service_version'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `service_version` when calling `services_by_key_version_get`")  # noqa: E501

        if self.api_client.client_side_validation and 'service_key' in local_var_params and not re.search(r'^(simcore)\/(services)\/(comp|dynamic)(\/[^\s\/]+)+$', local_var_params['service_key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `service_key` when calling `services_by_key_version_get`, must conform to the pattern `/^(simcore)\/(services)\/(comp|dynamic)(\/[^\s\/]+)+$/`")  # noqa: E501
        if self.api_client.client_side_validation and 'service_version' in local_var_params and not re.search(r'^(0|[1-9]\d*)(\.(0|[1-9]\d*)){2}(-(0|[1-9]\d*|\d*[-a-zA-Z][-\da-zA-Z]*)(\.(0|[1-9]\d*|\d*[-a-zA-Z][-\da-zA-Z]*))*)?(\+[-\da-zA-Z]+(\.[-\da-zA-Z-]+)*)?$', local_var_params['service_version']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `service_version` when calling `services_by_key_version_get`, must conform to the pattern `/^(0|[1-9]\d*)(\.(0|[1-9]\d*)){2}(-(0|[1-9]\d*|\d*[-a-zA-Z][-\da-zA-Z]*)(\.(0|[1-9]\d*|\d*[-a-zA-Z][-\da-zA-Z]*))*)?(\+[-\da-zA-Z]+(\.[-\da-zA-Z-]+)*)?$/`")  # noqa: E501
        collection_formats = {}
