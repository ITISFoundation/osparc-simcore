...
from settings_library.base1 import BaseCustomSettings, DefaultFromEnvFactoryError
...
def test_toggle_plugin_1(monkeypatch, fake_main_settings_with_postgres):
    ...
    s4 = (
        _MainSettings.AsNullableDefaultAuto()
    )  # cannot resolve default, then null -> disabled
    s5 = _MainSettings.AsNullableDefaultNull()  # disabled by default
