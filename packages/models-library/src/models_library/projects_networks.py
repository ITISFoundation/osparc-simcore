...
type DockerNetworkName = Annotated[str, StringConstraints(pattern=SERVICE_NETWORK_RE)]

type DockerNetworkAlias = Annotated[str, StringConstraints(pattern=SERVICE_NETWORK_RE)]
