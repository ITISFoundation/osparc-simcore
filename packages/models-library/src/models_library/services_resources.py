...
DEFAULT_SINGLE_SERVICE_NAME: Final[DockerGenericTag] = TypeAdapter(
    DockerGenericTag
).validate_strings("container")

MEMORY_50MB: Final[int] = TypeAdapter(ByteSize).validate_strings("50mib")
MEMORY_250MB: Final[int] = TypeAdapter(ByteSize).validate_strings("250mib")
MEMORY_1GB: Final[int] = TypeAdapter(ByteSize).validate_strings("1gib")
                ...
                # no compose spec (majority of services)
                {
                    DEFAULT_SINGLE_SERVICE_NAME: {
                        ...
                        "resources": {
                            ...
                            "RAM": {
                                "limit": TypeAdapter(ByteSize).validate_strings("2Gib"),
                                "reservation": TypeAdapter(ByteSize).validate_strings(
                                    "2Gib"
                                ),
                            },
                        },
