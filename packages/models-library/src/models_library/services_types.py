...
type FileName = Annotated[str, StringConstraints(pattern=FILENAME_RE)]
...
type DynamicServiceKey = Annotated[str, StringConstraints(pattern=DYNAMIC_SERVICE_KEY_RE)]
