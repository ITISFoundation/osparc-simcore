...
#   filename:  https://docs.docker.com/reference/api/engine/version/v1.44.yaml
#   timestamp: 2025-11-13T12:30:34+00:00
...
class BindOptions(BaseModel):
    ...
    read_only_non_recursive: Annotated[
        bool | None,
        Field(
    ...
    read_only_force_recursive: Annotated[
        bool | None,
        Field(
...
class AppArmor(BaseModel):
    ...
    mode: Annotated[Mode1 | None, Field(alias="Mode")] = None
...
class Topology(RootModel[dict[str, str]]):
    """
...
class PortMap(RootModel[dict[str, list[PortBinding]]]):
    """
...
class ServiceSpec(BaseModel):
    ...
    mode: Annotated[
        Mode2 | None,
        Field(alias="Mode", description="Scheduling mode for the service."),
    ] = None
...
class AccessMode(BaseModel):
    ...
    accessibility_requirements: Annotated[
...
class ClusterVolume(BaseModel):
    ...
    created_at: Annotated[str | None, Field(alias="CreatedAt")] = None
    updated_at: Annotated[str | None, Field(alias="UpdatedAt")] = None
    spec: Annotated[ClusterVolumeSpec | None, Field(alias="Spec")] = None
    info: Annotated[
        Info | None,
        Field(
            alias="Info",
...
class Volume(BaseModel):
    ...
    cluster_volume: Annotated[ClusterVolume | None, Field(alias="ClusterVolume")] = None
    options: Annotated[
        dict[str, str],
        Field(
            alias="Options",
