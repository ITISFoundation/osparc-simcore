...
class CompatibleService(BaseModel):
    key: Annotated[
        ServiceKey | None,
        Field(description="If None, it refer to current service. Used only for inter-service compatibility"),
    ] = None
    version: ServiceVersion


class Compatibility(BaseModel):
    can_update_to: Annotated[CompatibleService, Field(description="Latest compatible service at this moment")]
...
class ServiceRelease(BaseModel):
    version: ServiceVersion
    version_display: Annotated[str | None, Field(description="If None, then display `version`")] = None
    released: Annotated[
        datetime | None,
