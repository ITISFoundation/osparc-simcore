...
def _assert_same_value(ps_util_disk_usage: _SDiskUsage) -> None:
...
@pytest.mark.parametrize(
    "ps_util_disk_usage",
    [
        _SDiskUsage(total=77851254784, used=58336940032, free=19497537536, percent=74.9),
        _SDiskUsage(total=77851254784, used=58573619200, free=19260858368, percent=75.3),
        _SDiskUsage(total=77851254784, used=58573529088, free=19260948480, percent=75.3),
        _SDiskUsage(total=77851254784, used=58573664256, free=19260813312, percent=75.3),
    ],
)
def test_disk_usage_regression_cases(ps_util_disk_usage: _SDiskUsage):
