...
def test_substitution_with_new_and_legacy_identifiers():
    ...
    compose_spec:
        service-one:
            ...
            environment:
                ...
                - MY_LICENSE_FILE=${OSPARC_VENDOR_SECRET_LICENSE_FILE}
    ...
    containers-allowed-outgoing-permit-list:
        s4l-core:
            - hostname: $OSPARC_VENDOR_SECRET_LICENSE_SERVER_HOST
              tcp_ports: [$OSPARC_VENDOR_SECRET_LICENSE_SERVER_PRIMARY_PORT, $OSPARC_VENDOR_SECRET_LICENSE_SERVER_SECONDARY_PORT]
              dns_resolver:
                  address: $OSPARC_VENDOR_SECRET_LICENSE_DNS_RESOLVER_IP
                  port: $OSPARC_VENDOR_SECRET_LICENSE_DNS_RESOLVER_PORT
    ...
    assert identifiers == [
        ...
        "OSPARC_ENVIRONMENT_SERVICE_UUID",
        # -----
        "OSPARC_VENDOR_SECRET_LICENSE_FILE",
        "OSPARC_ENVIRONMENT_CURRENT_PRODUCT",
        "OSPARC_ENVIRONMENT_USER_EMAIL",
        "KEEP_SINCE_IT_WAS_EXCLUDED_FROM_SUBSTITUTIONS",
        "OSPARC_VENDOR_SECRET_LICENSE_SERVER_HOST",
        "OSPARC_VENDOR_SECRET_LICENSE_SERVER_PRIMARY_PORT",
        "OSPARC_VENDOR_SECRET_LICENSE_SERVER_SECONDARY_PORT",
        "OSPARC_VENDOR_SECRET_LICENSE_DNS_RESOLVER_IP",
        "OSPARC_VENDOR_SECRET_LICENSE_DNS_RESOLVER_PORT",
    ]
