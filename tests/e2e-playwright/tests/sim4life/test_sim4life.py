...
def test_sim4life(
    ...
    # NOTE: the test is done with this websocket: closing it during teardown (e.g. when the
    # project is closed) is expected, so do not treat it as a disconnection needing a reconnect
