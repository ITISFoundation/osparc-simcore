...
### Changed
* Explicitly set font-display to block which suppresses warnings of font-display
...
* The film-canister icon was incorrectly spelled film-canister
...
* Sass placeholder selector added for %fa-icon to fix CSS precedence issue with font-weight
...
* Modified the star icons to match use case better FortAwesome/Font-Awesome-Pro#710
