  ...
  members: {
    ...
    copyFile: function(fromLoc, fileUuid, toLoc, pathId) {
      ...
      osparc.data.Resources.fetch("storageFiles", "copy", params)
        ...
        .catch(err => {
          console.error(err);
          console.error("Unsuccessful file copy", fileUuid, "to", pathId);
          osparc.FlashMessenger.getInstance().logAs(this.tr("Unsuccessful file copy"), "ERROR");
    ...
    deleteFile: function(locationId, fileUuid) {
      ...
      return osparc.data.Resources.fetch("storageFiles", "delete", params)
        ...
        .catch(err => {
          console.error(err);
          osparc.FlashMessenger.getInstance().logAs(this.tr("Unsuccessful file deletion"), "ERROR");
        });
    }
  }
});
