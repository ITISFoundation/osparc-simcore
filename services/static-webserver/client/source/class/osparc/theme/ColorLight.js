qx.Theme.define("osparc.theme.ColorLight", {
  ...
  colors: {
    ...
    "pb-hovered": "rgba(0, 0, 0, 0.1)", // subtle darken overlay on hover
    ...
    "text-opa70": "rgba(40, 40, 40, 0.7)",
    "text-opa30": "rgba(40, 40, 40, 0.3)",
    ...
    "workbench-view-navbar": "background-main-1",
