...
qx.Class.define("osparc.product.tutorial.s4llite.Dashboard", {
  ...
  members: {
    _populateCard: function() {
      ...
      ");
      const newProject = osparc.product.tutorial.Utils.createLabel(newProjectText);
      ...
      ");
      const otherProjects = osparc.product.tutorial.Utils.createLabel(otherProjectsText);
      ...
      ");
      const otherProjects2 = osparc.product.tutorial.Utils.createLabel(otherProjects2Text);
      ...
      ");
      const importProjects = osparc.product.tutorial.Utils.createLabel(importProjectsText);
