...
qx.Class.define("osparc.component.tutorial.ti.ElectrodeSelector", {
  ...
  members: {
    _populateCard: function() {
      ...
      ");
      const label1 = osparc.component.tutorial.Utils.createLabel(text1);
      this._add(label1);
      ...
      ");
      const label2 = osparc.component.tutorial.Utils.createLabel(text2);
      this._add(label2);
      ...
      ");
      const label4 = osparc.component.tutorial.Utils.createLabel(text4);
      this._add(label4);

      const text5 = this.tr("\
        Now the Arrow that says 'Next' can be pushed and the optimization will inmediatly start.\
      ");
      const label5 = osparc.component.tutorial.Utils.createLabel(text5);
      this._add(label5);
    }
  }
});
