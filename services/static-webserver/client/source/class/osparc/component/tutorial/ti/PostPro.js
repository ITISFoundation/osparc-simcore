...
qx.Class.define("osparc.component.tutorial.ti.PostPro", {
  ...
  members: {
    _populateCard: function() {
      ...
      ");
      const label1 = osparc.component.tutorial.SlideBase.createLabel(text1);
      this._add(label1);
      ...
      ");
      const label2 = osparc.component.tutorial.SlideBase.createLabel(text2);
      this._add(label2);
      ...
      ");
      const label3 = osparc.component.tutorial.SlideBase.createLabel(text3);
      this._add(label3);
      ...
      ");
      const label4 = osparc.component.tutorial.SlideBase.createLabel(text4);
      this._add(label4);
