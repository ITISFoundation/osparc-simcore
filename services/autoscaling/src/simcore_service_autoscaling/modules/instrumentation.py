...
class AutoscalingInstrumentation:
    ...
    def update_from_cluster(self, cluster: Cluster) -> None:
        _update_gauge(self.active_nodes, cluster.active_nodes)
        _update_gauge(self.pending_nodes, cluster.pending_nodes)
        _update_gauge(self.drained_nodes, cluster.drained_nodes)
        _update_gauge(self.buffer_drained_nodes, cluster.reserve_drained_nodes)
        _update_gauge(self.pending_ec2s, cluster.pending_ec2s)
