...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            {
                f"{INSTANCE_PRE_PULLED_IMAGES_EC2_TAG_KEY}_0": '["itisfoundation/dynamic-sidecar:latest",'
                '"itisfoundation/agent:latest","registry.pytest.com/simcore/services/dynamic/ti-postpro:2.0.34",'
                '"registry.pytest.com/simcore/services/dynamic/ti-simu:1.0.12",'
                '"registry.pytest.com/simcore/services/dynamic/ti-pers:1.0.',
                f"{INSTANCE_PRE_PULLED_IMAGES_EC2_TAG_KEY}_1": '19",'
                '"registry.pytest.com/simcore/services/dynamic/sim4life-postpro:2.0.106",'
                '"registry.pytest.com/simcore/services/dynamic/s4l-core-postpro:2.0.106",'
                '"registry.pytest.com/simcore/services/dynamic/s4l-core-stream:2.0.106",'
                '"registry.pytest.com/simcore/services',
                f"{INSTANCE_PRE_PULLED_IMAGES_EC2_TAG_KEY}_2": '/dynamic/sym-server-8-0-0-dy:2.0.106",'
                '"registry.pytest.com/simcore/services/dynamic/sim4life-8-0-0-modeling:3.2.34",'
                '"registry.pytest.com/simcore/services/dynamic/s4l-core-8-0-0-modeling:3.2.34",'
                '"registry.pytest.com/simcore/services/dynamic/s4l-stream-8-0-0',
                f"{INSTANCE_PRE_PULLED_IMAGES_EC2_TAG_KEY}_3": '-dy:3.2.34",'
                '"registry.pytest.com/simcore/services/dynamic/sym-server-8-0-0-dy:3.2.34"]',
            },
        ...
        pytest.param(
            ...
            {
                INSTANCE_PRE_PULLED_IMAGES_EC2_TAG_KEY: '["itisfoundation/dynamic-sidecar:latest",'
                '"itisfoundation/agent:latest"]'
            },
...
def test_load_pre_pulled_images_backward_compatibility_single_tag():
    ...
    single_format_tags: EC2Tags = {INSTANCE_PRE_PULLED_IMAGES_EC2_TAG_KEY: '["image:v1","image:v2","image:v3"]'}
...
def test_load_pre_pulled_images_malformed_json_raises():
    malformed_tags: EC2Tags = {INSTANCE_PRE_PULLED_IMAGES_EC2_TAG_KEY: "not-valid-json{"}
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            {
                f"{INSTANCE_PRE_PULLED_IMAGES_EC2_TAG_KEY}_0": '["itisfoundation/dynamic-sidecar:latest",'
                '"itisfoundation/agent:latest","registry.pytest.com/simcore/services/dynamic/ti-postpro:2.0.34","registry.pytest.com/simcore/services/dynamic/ti-simu:1.0.12","registry.pytest.com/simcore/services/dynamic/ti-pers:1.0.',
                f"{INSTANCE_PRE_PULLED_IMAGES_EC2_TAG_KEY}_1": '19",'
                '"registry.pytest.com/simcore/services/dynamic/sim4life-postpro:2.0.106","registry.pytest.com/simcore/services/dynamic/s4l-core-postpro:2.0.106","registry.pytest.com/simcore/services/dynamic/s4l-core-stream:2.0.106","registry.pytest.com/simcore/services',
                f"{INSTANCE_PRE_PULLED_IMAGES_EC2_TAG_KEY}_2": '/dynamic/sym-server-8-0-0-dy:2.0.106",'
                '"registry.pytest.com/simcore/services/dynamic/sim4life-8-0-0-modeling:3.2.34","registry.pytest.com/simcore/services/dynamic/s4l-core-8-0-0-modeling:3.2.34","registry.pytest.com/simcore/services/dynamic/s4l-stream-8-0-0',
                f"{INSTANCE_PRE_PULLED_IMAGES_EC2_TAG_KEY}_3": '-dy:3.2.34",'
                '"registry.pytest.com/simcore/services/dynamic/sym-server-8-0-0-dy:3.2.34"]',
            },
            id="many images that get chunked to AWS Tag max length",
