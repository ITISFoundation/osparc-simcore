...
def _write_random_binary_file(file_path: Path, total_size: ByteSize, *, chunk_size: ByteSize = _DEFAULT_CHUNK_SIZE):
...
def free_reserved_disk_space() -> None:
...
def setup(app: FastAPI) -> None:
    ...
    _write_random_binary_file(_RESERVED_DISK_SPACE_NAME, settings.DYNAMIC_SIDECAR_RESERVED_SPACE_SIZE)
