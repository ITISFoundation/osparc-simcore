...
def test_building_sql_statements(faker: Faker):
    ...
    # WHERE file_meta_data.user_id = '42' AND file_meta_data.is_directory IS false
    #   ORDER BY file_meta_data.created_at ASC
    ...
    # WHERE (file_meta_data.user_id = '42' OR file_meta_data.project_id IN ('18d5'..., ))
    #   AND file_meta_data.is_directory IS false ORDER BY file_meta_data.created_at ASC
    ...
    # (file_meta_data.user_id = '42' OR file_meta_data.project_id IN ('3cd9704db' ...))
    #   AND file_meta_data.is_directory IS false
    #   ORDER BY file_meta_data.created_at ASC LIMIT 10 OFFSET 1
