...
from servicelib.celery.models import BaseExecutionMetadata, OwnerMetadata, Wildcard
...
async def _assert_compute_path_size(
    ...
    *,
    ...
    async_job = await submit_job(
        task_manager,
        execution_metadata=BaseExecutionMetadata(name="compute_path_size"),
...
async def _assert_delete_paths(
    ...
    *,
    ...
    async_job = await submit_job(
        task_manager,
        execution_metadata=BaseExecutionMetadata(name="delete_paths"),
        owner_metadata=TestOwnerMetadata(user_id=user_id, product_name=product_name, owner="pytest_client_name"),
        location_id=location_id,
        user_id=user_id,
        paths=paths,
