...
class Fake(object):
    ...
    def path_value(self, path_value):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and path_value is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `path_value`, must not be `None`"
            )  # noqa: E501
    ...
    def query_value(self, query_value):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and query_value is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `query_value`, must not be `None`"
            )  # noqa: E501
    ...
    def body_value(self, body_value):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and body_value is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `body_value`, must not be `None`"
            )  # noqa: E501
