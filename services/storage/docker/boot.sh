...
if [ "${SC_BUILD_TARGET}" = "development" ]; then
  ...
  entrypoint='watchmedo auto-restart --recursive --pattern="*.py;*/src/*" --ignore-patterns="*test*" --ignore-directories --directory /devel/services/storage/src --directory /devel/packages --'
