...
Pre-release and development versions are denoted appending a hyphen, i.e. 0.2.0-dev

Build metadata (e.g. git commit id, build id, ...) can be appended with a plus, i.e. 0.2.0-dev+asd21ff
...
try:
    ...
    assert __version__=="0.2.0", "Did you install this package?"
