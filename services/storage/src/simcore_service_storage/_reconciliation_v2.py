...
# Incremental S3/DB reconciliation (v2):
# - Iterate DB/references (small side), not full S3 keyspace.
# - Resume safely across redeploys via Redis cursor/snapshot state.
# - Keep one consistent reachability snapshot per logical pass.
