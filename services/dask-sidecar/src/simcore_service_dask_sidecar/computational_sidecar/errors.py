...
class ServiceMissingOutputError(ComputationalSidecarException):
    """Error in service expected outputs"""

    def __init__(self, service_key: str, service_version: str, output_key: str) -> None:
        super().__init__(
            f"The service {service_key}:{service_version} did not produce the expected output for {output_key}"
        )
...
class ServiceBadFormattedOutputError(ComputationalSidecarException):
    ...
    def __init__(self, service_key: str, service_version: str, output_key: str) -> None:
        super().__init__(
            f"The service {service_key}:{service_version} produced badly formatted data for {output_key}"
        )
