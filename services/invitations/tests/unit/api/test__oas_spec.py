...
def test_openapi_json_is_in_sync_with_app_oas(client: TestClient, project_slug_dir: Path):
    """
    ...
    assert spec_from_app == stored_openapi_json_file, "rerun `make openapi.json` and check differences"
