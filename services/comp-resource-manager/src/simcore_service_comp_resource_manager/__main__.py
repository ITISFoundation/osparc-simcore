""" Main application entry point
 ...
 `python -m simcore_service_comp_resource_manager ...`
...
from simcore_service_comp_resource_manager.core.settings import (
    AppSettings,
    BootModeEnum,
)
...
def main():
    ...
    uvicorn.run(
        "simcore_service_comp_resource_manager.__main__:the_app",
        host=cfg.host,
        port=cfg.port,
