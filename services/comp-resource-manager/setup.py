...
setup(
    name="simcore-service-comp-resource-manager",
    version=version,
    author="Sylvain Anderegg (sanderegg)",
    description="Platform's computational resource manager",
    classifiers=[
    ...
    entry_points={
        "console_scripts": [
            "simcore-service-comp-resource-manager = simcore_service_comp_resource_manager.__main__:main",
        ],
    },
)
