...
import pytest
import respx
import simcore_service_comp_resource_manager.api.routes.solvers
from fastapi import FastAPI
from httpx import Response
from simcore_service_comp_resource_manager.core.application import init_app
from simcore_service_comp_resource_manager.core.settings import AppSettings
...
def test_list_solvers(sync_client: TestClient, mocked_catalog_service_api, mocker):
    ...
    warn = mocker.patch.object(
        simcore_service_comp_resource_manager.api.routes.solvers.logger, "warning"
    )
