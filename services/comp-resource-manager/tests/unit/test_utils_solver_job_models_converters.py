...
from simcore_service_comp_resource_manager.models.schemas.jobs import (
    ArgumentType,
    Job,
    JobInputs,
)
from simcore_service_comp_resource_manager.models.schemas.solvers import Solver
from simcore_service_comp_resource_manager.utils.solver_job_models_converters import (
...
def test_create_jobstatus_from_task():
    from simcore_service_comp_resource_manager.models.schemas.jobs import JobStatus
    from simcore_service_comp_resource_manager.modules.director_v2 import (
        ComputationTaskOut,
    )
