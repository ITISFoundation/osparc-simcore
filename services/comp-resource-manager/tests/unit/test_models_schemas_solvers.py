...
import pytest
from simcore_service_comp_resource_manager.api.routes._solvers_faker import SolversFaker
from simcore_service_comp_resource_manager.models.schemas.solvers import Solver, Version
