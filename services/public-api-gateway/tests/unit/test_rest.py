...
from simcore_service_public_api_gateway.rest import setup_rest
from simcore_service_public_api_gateway.application_config import APP_CONFIG_KEY
from simcore_service_public_api_gateway import __version__
...
async def test_check_health(client):
    ...
    assert data['name'] == 'simcore_service_public_api_gateway'
