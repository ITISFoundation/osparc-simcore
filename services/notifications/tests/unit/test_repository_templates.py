...
from simcore_service_notifications.models.template import NotificationsTemplateRef
...
@pytest.fixture
def templates_repository(mock_jinja_env: Environment) -> NotificationsTemplatesRepository:
    """Create a NotificationsTemplatesRepository instance with mock templates."""
    return NotificationsTemplatesRepository(env=mock_jinja_env)
...
def test_search_templates_no_filters(
    templates_repository: NotificationsTemplatesRepository,
) -> None:
