...
def create_startup_script(
    ...
    environment_variables = [
        ...
        f"EC2_INSTANCES_ALLOWED_TYPES={_convert_to_env_list(app_settings.CLUSTERS_KEEPER_WORKERS_EC2_INSTANCES.CLUSTERS_KEEPER_WORKERS_EC2_INSTANCES_ALLOWED_TYPES)}",
        f"EC2_INSTANCES_AMI_ID={app_settings.CLUSTERS_KEEPER_WORKERS_EC2_INSTANCES.CLUSTERS_KEEPER_WORKERS_EC2_INSTANCES_AMI_ID}",
        f"EC2_INSTANCES_CUSTOM_BOOT_SCRIPTS={_convert_to_env_list(app_settings.CLUSTERS_KEEPER_WORKERS_EC2_INSTANCES.CLUSTERS_KEEPER_WORKERS_EC2_INSTANCES_CUSTOM_BOOT_SCRIPTS)}",
        ...
        f"EC2_INSTANCES_SECURITY_GROUP_IDS={_convert_to_env_list(app_settings.CLUSTERS_KEEPER_WORKERS_EC2_INSTANCES.CLUSTERS_KEEPER_WORKERS_EC2_INSTANCES_SECURITY_GROUP_IDS)}",
