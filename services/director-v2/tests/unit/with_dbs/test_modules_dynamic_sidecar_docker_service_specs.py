...
def mock_s3_settings() -> S3Settings:
    return S3Settings.parse_obj(S3Settings.model_config["json_schema_extra"]["examples"][0])
            ...
            "io.simcore.scheduler-data": SchedulerData.parse_obj(
                {
                    ...
                    "callbacks_mapping": CallbacksMapping.model_config["json_schema_extra"][
                        "examples"
                    ][3],
                    ...
                    "wallet_info": WalletInfo.model_config["json_schema_extra"]["examples"][0],
                    "pricing_info": PricingInfo.model_config["json_schema_extra"]["examples"][0],
