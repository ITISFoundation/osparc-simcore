...
def init_app(settings: Optional[AppSettings] = None) -> FastAPI:
    ...
    if settings.DIRECTOR_V2_COMPUTATIONAL_BACKEND.DIRECTOR_V2_DASK_CLIENT_ENABLED:
        dask_clients_pool.setup(app, settings.DIRECTOR_V2_COMPUTATIONAL_BACKEND)

    if settings.DIRECTOR_V2_COMPUTATIONAL_BACKEND.DIRECTOR_V2_DASK_SCHEDULER_ENABLED:
        rabbitmq.setup(app)
