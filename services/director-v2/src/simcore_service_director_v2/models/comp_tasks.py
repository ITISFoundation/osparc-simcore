...
class BaseCompTaskAtDB(BaseModel):
    ...
    run_hash: str | None = Field(
        default=None,
        description="the hex digest of the resolved inputs +outputs hash "
        "at the time when the last outputs were generated",
    )
    image: Image
                    ...
                    "schema": {
                        "inputs": {
                            "input_1": {
                                ...
                                "will be downloaded in an inputs folder.",
                                "type": "data:*/*",
                                "displayOrder": 1.0,
                            }
                        },
