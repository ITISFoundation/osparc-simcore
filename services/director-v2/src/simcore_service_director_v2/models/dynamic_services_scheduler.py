...
DockerId = Annotated[str, StringConstraints(max_length=25, pattern=r"[A-Za-z0-9]{25}")]
...
ServiceName = Annotated[str, StringConstraints(strip_whitespace=True, min_length=2)]
