...
async def process_message(app: FastAPI, data: bytes) -> bool:
    ...
    # 4. Check whether number of top-ups is still in the limit
    ...
    if (
        ...
        _logger.warning("Current month spending")
        return True  # --> We do not auto recharge
    ...
    ## 6.2 Make payment
    assert _payments_transactions_repo
