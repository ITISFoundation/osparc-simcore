...
NAME = "simcore-service-efs-guardian"
VERSION = (CURRENT_DIR / "VERSION").read_text().strip()
AUTHORS = ("Matus Drobuliak (drobuliakmatus66)",)
...
SETUP = {
    ...
    "entry_points": {
        "console_scripts": [
            "simcore-service-efs-guardian = simcore_service_efs_guardian.cli:main",
            "simcore-service = simcore_service_efs_guardian.cli:main",
        ],
    },
}
