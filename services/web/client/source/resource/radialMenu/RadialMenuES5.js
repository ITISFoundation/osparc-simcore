...
;(function(root) {
	 ...
	 */
	function RadialMenu({fontFamily, fontSize, innerCircle, outerCircle,
	...
	RadialMenu.prototype.init = function(){
	...
	RadialMenu.prototype.addEvent = function(){
	...
	RadialMenu.prototype.distance = function(x1, y1, x2, y2){
	...
	RadialMenu.prototype.setPos = function(x, y){
	...
	RadialMenu.prototype.createGradient = function(obj){
	...
	RadialMenu.prototype.checkButtons = function(){
	...
	RadialMenu.prototype.addButtons = function(buttons){
	...
	if (typeof module !== 'undefined' && typeof exports === 'object') {
		...
		define(function() { return RadialMenu; });
	} else {
		root.RadialMenu = RadialMenu;
	}
