  ...
  members: {
    ...
    validateToken: function(successCb, errorCb, ctx) {
      if (qxapp.auth.Data.getInstance().isLogout()) {
        ...
        qxapp.data.Resources.getOne("profile", {}, null, false)
          .then(profile => {
    ...
    login: function(email, password, successCbk, failCbk, context) {
      ...
      qxapp.data.Resources.fetch("auth", "postLogin", params)
        .then(data => {
    ...
    logout: function() {
      qxapp.data.Resources.fetch("auth", "getLogout");
      this.__logoutUser();
    ...
    register: function(userData, successCbk, failCbk, context) {
      ...
      qxapp.data.Resources.fetch("auth", "postRegister", params)
        .then(data => {
          successCbk.call(context, data);
        })
        .catch(err => failCbk.call(context, err.message));
    ...
    resetPasswordRequest: function(email, successCbk, failCbk, context) {
      ...
      qxapp.data.Resources.fetch("auth", "postRequestResetPassword", params)
        .then(data => {
          successCbk.call(context, data);
        })
        .catch(err => failCbk.call(context, err.message));
    ...
    resetPassword: function(newPassword, confirmation, code, successCbk, failCbk, context) {
      ...
      qxapp.data.Resources.fetch("auth", "postResetPassword", params)
        .then(data => {
          successCbk.call(context, data);
        })
        .catch(err => failCbk.call(context, err.message));
