qx.Class.define("qxapp.components.widgets.ThreeDApp", {
  ...
  construct : function(initWidth, initHeight) {
    ...
    let threeDView = this.__threeDView = new qxapp.components.widgets.ThreeDView(initWidth, initHeight, backgroundColor);
