      ...
      switch (portKey) {
        ...
        case "materialDB":
          return [{
            ...
            label: "Intervertebral_Disc"
          }, {
            key: "Cerebrospinal_Fluid-UUID",
            label: "Cerebrospinal_Fluid"
          }, {
            key: "Bronchi-UUID",
            label: "Bronchi"
          }, {
            key: "Commissura_Posterior-UUID",
            label: "Commissura_Posterior"
          }, {
            key: "Blood-UUID",
            label: "Blood"
          }, {
            key: "Commissura_Anterior-UUID",
            label: "Commissura_Anterior"
          }, {
            key: "Brain_(White_Matter)-UUID",
            label: "Brain_(White_Matter)"
          }, {
            key: "Cartilage-UUID",
            label: "Cartilage"
          }, {
            key: "Brain_(Grey_Matter)-UUID",
            label: "Brain_(Grey_Matter)"
          }, {
            key: "Air-UUID",
            label: "Air"
          }, {
            key: "Eye_(Vitreous_Humor)-UUID",
            label: "Eye_(Vitreous_Humor)"
          }, {
            key: "Eye_(Lens)-UUID",
            label: "Eye_(Lens)"
          }, {
            ...
            label: "Esophagus_Lumen"
          }, {
            key: "Esophagus-UUID",
            label: "Esophagus"
          }, {
            key: "Eye_(Cornea)-UUID",
            label: "Eye_(Cornea)"
          }, {
            key: "Eye_(Sclera)-UUID",
            label: "Eye_(Sclera)"
          }, {
            key: "Lymphnode-UUID",
            label: "Lymphnode"
            ...
            label: "Salivary_Gland"
          }, {
            key: "Mucous_Membrane-UUID",
            label: "Mucous_Membrane"
          }, {
            key: "SAT_(Subcutaneous_Fat)-UUID",
            label: "SAT_(Subcutaneous_Fat)"
          }, {
            key: "Tongue-UUID",
            label: "Tongue"
          }, {
            ...
            key: "Bone_Marrow_(Yellow)-UUID",
            label: "Bone_Marrow_(Yellow)"
          }, {
            key: "Bone_(Cancellous)-UUID",
            label: "Bone_(Cancellous)"
          }, {
            key: "Bone_(Cortical)-UUID",
            label: "Bone_(Cortical)"
          }, {
            key: "Skull_Cortical-UUID",
            label: "Skull_Cortical"
          }, {
            key: "Silicone-UUID",
            label: "Silicone"
          }, {
