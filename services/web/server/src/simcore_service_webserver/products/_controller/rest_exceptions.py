...
_TO_HTTP_ERROR_MAP: ExceptionToHttpErrorMap = {
    ProductNotFoundError: HttpErrorInfo(
        ...
        user_message("This product could not be found." + MSG_TRY_AGAIN_OR_SUPPORT, _version=1),
    ),
    MissingStripeConfigError: HttpErrorInfo(
        status.HTTP_503_SERVICE_UNAVAILABLE,
        user_message(
            "This service is temporarily unavailable due to a configuration issue. " + MSG_TRY_AGAIN_OR_SUPPORT,
            _version=1,
        ),
    ),
}
