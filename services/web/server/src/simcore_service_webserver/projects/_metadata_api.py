...
from ._access_rights_api import check_project_ownership
...
async def get_project_custom_metadata(
    ...
    await check_project_ownership(app, user_id=user_id, project_uuid=project_uuid)

    return await get_project_metadata(
