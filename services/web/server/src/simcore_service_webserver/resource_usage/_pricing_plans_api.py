...
async def get_default_service_pricing_plan(
    ...
    data: rut_api_schemas.ServicePricingPlanGet = await resource_tracker_client.get_default_service_pricing_plan(  # type: ignore[no-redef]
        app=app,
...
async def get_pricing_plan_unit(
    ...
    data: rut_api_schemas.PricingUnitGet = await resource_tracker_client.get_pricing_plan_unit(  # type: ignore[no-redef]
        app=app,
        product_name=product_name,
