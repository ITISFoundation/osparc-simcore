...
from ._models import LicensedItemsPurchasesPathParams, LicensedItemsRequestContext
...
@routes.get(
    f"/{VTAG}/catalog/licensed-items-purchases", name="list_licensed_items_purchases"
)
@login_required
