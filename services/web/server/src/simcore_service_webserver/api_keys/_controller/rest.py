...
async def list_api_keys(request: web.Request):
    ...
    query_params: ApiKeyListQueryParams = parse_request_query_parameters_as(ApiKeyListQueryParams, request)
    ...
    return envelope_json_response(TypeAdapter(list[ApiKeyGet]).validate_python(api_keys))
