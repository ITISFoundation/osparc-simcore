...
@dataclass
class HttpApiCallSnapshot:
    """
    Keeps a (copy&pasted) snapshot of the payload and response (from browser's Developer Tools) of a given http call
    """
...
@pytest.fixture
def replace_project_req():
    return HttpApiCallSnapshot(
        call="PUT projects/ef6fa0a8-534d-11ec-89f5-02420a0fd439",
        request_payload={
            "uuid": "ef6fa0a8-534d-11ec-89f5-02420a0fd439",
            "name": "New Study",
            "description": "",
...
@pytest.fixture
def replace_project_after_change_req():
    return HttpApiCallSnapshot(
        call="PUT projects/ef6fa0a8-534d-11ec-89f5-02420a0fd439",
        request_payload={
            "uuid": "ef6fa0a8-534d-11ec-89f5-02420a0fd439",
...
def test_models_when_creating_new_empty_project(new_project_req: HttpApiCallSnapshot):

    project_in_new = ProjectAsBody.parse_obj(new_project_req.request_payload)
    project_as_body = ProjectAsBody.parse_obj(new_project_req.response_body["data"])


def test_models_when_replacing_an_opened_project(
    replace_project_req: HttpApiCallSnapshot,
):

    project_in_replace = ProjectAsBody.parse_obj(replace_project_req.request_payload)
    project_as_body = ProjectAsBody.parse_obj(replace_project_req.response_body["data"])


def test_models_when_saving_after_project_change(
    replace_project_after_change_req: HttpApiCallSnapshot,
):

    project_in_replace = ProjectAsBody.parse_obj(
        replace_project_after_change_req.request_payload
    )
    project_as_body = ProjectAsBody.parse_obj(
        replace_project_after_change_req.response_body["data"]
    )
