...
@pytest.mark.parametrize(
    ...
    [
        (
            str(
                ...
                .with_query(
                    ...
                    file_size="300",
                    file_name="orchestra.csv",
                    download_link=_DOWNLOAD_LINK3,
                )
            ),
            _DOWNLOAD_LINK3,
        ),
        ...
        (
            str(
                URL("https://123.123.0.1:9000")
                .with_path("/view")
                .with_query(file_type="VTK", file_size="300", download_link=_DOWNLOAD_LINK1)
            ),
            _DOWNLOAD_LINK1,
        ),
    ],
