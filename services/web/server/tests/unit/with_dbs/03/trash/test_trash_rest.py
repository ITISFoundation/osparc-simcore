...
# All tests in this module can list projects; keep the new external RPC boundary local to this module.
@pytest.fixture(autouse=True)
def mock_list_computations_latest_states(mocker: MockerFixture) -> None:
    mocker.patch(
