...
# tracing
TRACING_OTEL_COLLECTOR_PORT: str = os.environ.get("TRACING_OTEL_COLLECTOR_PORT")
TRACING_OTEL_COLLECTOR_ENDPOINT: str = os.environ.get("TRACING_OTEL_COLLECTOR_ENDPOINT")
