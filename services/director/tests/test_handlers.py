...
async def test_running_services_post_and_delete_no_swarm(add_swarm_stack_name, client, push_services, user_id, project_id, api_version_prefix): #pylint: disable=W0613, W0621
    params = {
        "user_id": "None",
        "project_id": "None",
        "service_uuid": "sdlfkj4",
...
async def test_running_services_post_and_delete(add_swarm_stack_name, client, push_services, docker_swarm, user_id, project_id, api_version_prefix): #pylint: disable=W0613, W0621
