...
def create_json_error_response(*errors, status_code: int) -> JSONResponse:
...
async def http_error_handler(_: Request, exc: HTTPException) -> JSONResponse:
    return create_json_error_response(exc.detail, status_code=exc.status_code)
...
def make_http_error_handler_for_exception(
    ...
    *,
    ...
    async def _http_error_handler(_: Request, exc: type[BaseException]) -> JSONResponse:
        ...
        return create_json_error_response(details, status_code=exc.status_code)
