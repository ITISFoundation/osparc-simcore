...
from .process_message_project_sync import process_message
...
async def _subscribe_to_rabbitmq(app) -> str:
    with log_context(_logger, logging.INFO, msg="Subscribing to rabbitmq channel"):
        ...
        subscribed_queue: str = await rabbit_client.subscribe(
            RabbitResourceTrackingProjectSyncMessage.get_channel_name(),
...
def on_app_startup(app: FastAPI) -> Callable[[], Awaitable[None]]:
    async def _startup() -> None:
        with log_context(
            ...
            app.state.resource_tracker_rabbitmq_consumer__project_sync = None
            ...
            if not settings:
                ...
                return
            app.state.resource_tracker_rabbitmq_consumer__project_sync = (
