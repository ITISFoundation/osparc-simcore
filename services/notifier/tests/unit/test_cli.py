...
from simcore_service_notifier._meta import API_VERSION
from simcore_service_notifier.cli import main as cli_main
from simcore_service_notifier.core.settings import ApplicationSettings
from typer.testing import CliRunner


def test_cli_help_and_version(cli_runner: CliRunner):
    # simcore-service-notifiers --help
...
def test_echo_dotenv(cli_runner: CliRunner, monkeypatch: pytest.MonkeyPatch):
    # simcore-service-notifiers echo-dotenv --auto-password
...
def test_list_settings(cli_runner: CliRunner, app_environment: EnvVarsDict):
    # simcore-service-notifiers settings --show-secrets --as-json
...
def test_main(app_environment: EnvVarsDict):
    from simcore_service_notifier.main import the_app
