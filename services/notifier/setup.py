...
NAME = "simcore-service-notifiers"
VERSION = (CURRENT_DIR / "VERSION").read_text().strip()
AUTHORS = ("Pedro Crespo-Valero (pcrespov)",)
DESCRIPTION = "Service that manages creation and validation of registration notifiers"
...
SETUP = {
    ...
    "entry_points": {
        "console_scripts": [
            "simcore-service-notifiers = simcore_service_notifier.cli:main",
            "simcore-service = simcore_service_notifier.cli:main",
        ],
    },
