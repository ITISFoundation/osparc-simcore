...
@cached(
    ...
    key_builder=lambda f, *args, **kwargs: (
        f"{f.__name__}_{kwargs['x_datcore_api_key']}_{kwargs['x_datcore_api_secret']}_{kwargs['page_params']}"
    ),
)
...
@cached(
    ttl=_PENNSIEVE_CACHING_TTL_S,
    key_builder=lambda f, *args, **kwargs: (
        f"{f.__name__}_{kwargs['x_datcore_api_key']}_{kwargs['x_datcore_api_secret']}_{kwargs['dataset_id']}_{kwargs['page_params']}"
    ),
)
...
@cached(
    ttl=_PENNSIEVE_CACHING_TTL_S,
    key_builder=lambda f, *args, **kwargs: (
        f"{f.__name__}_{kwargs['x_datcore_api_key']}_{kwargs['x_datcore_api_secret']}_{kwargs['dataset_id']}_{kwargs['collection_id']}_{kwargs['page_params']}"
    ),
)
...
@cached(
    ttl=_PENNSIEVE_CACHING_TTL_S,
    key_builder=lambda f, *args, **kwargs: (
        f"{f.__name__}_{kwargs['x_datcore_api_key']}_{kwargs['x_datcore_api_secret']}_{kwargs['dataset_id']}"
    ),
)
